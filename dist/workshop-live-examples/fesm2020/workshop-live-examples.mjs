...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(WorkshopLiveExamplesService, [{
        type: Injectable,
        args: [{
                providedIn: 'root'
            }]
...
WorkshopLiveExamplesComponent.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: WorkshopLiveExamplesComponent, selectors: [["tmd-workshop-live-examples"]], decls: 2, vars: 0, template: function WorkshopLiveExamplesComponent_Template(rf, ctx) { if (rf & 1) {
        i0.ɵɵelementStart(0, "p");
        i0.ɵɵtext(1, " *****NPM MODULES workshop-live-examples works! Kelly\n");
        i0.ɵɵelementEnd();
    } } });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(WorkshopLiveExamplesComponent, [{
        type: Component,
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(WorkshopLiveExamplesModule, [{
        type: NgModule,
        args: [{
                declarations: [
